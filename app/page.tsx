  ...
  return (
    <PageMain minHeight={false}>
      ...
      <div className="flex flex-col gap-2.5 px-10 sm:px-16  max-w-3xl">
        ...
        <p>Prev. Product Design Internship at Dow Jones and Product Management Co-op at the Boston Globe. Currently job hunting and doing freelance design work on Broadway!</p>
